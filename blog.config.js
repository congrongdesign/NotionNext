...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '从容', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个PPT设计师🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://congrongppt.com', // 网站地址
